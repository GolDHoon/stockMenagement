...
@AllArgsConstructor
@Entity
@Table(name = "TB_STCK_CODE")
public class StckCode extends BasicEntity implements Serializable {
    ...
    @Nationalized
    @Column(name = "FullCode", nullable = false, length = 15)
    ...
    public BizzCode getParentsCode() {
        return parentsCode;
    }
    ...
    public void setParentsCode(BizzCode parentsCode) {
    ...
    public final boolean equals(Object o) {
        ...
        StckCode stckCode = (StckCode) o;
        return getId() != null && Objects.equals(getId(), stckCode.getId());
    }
